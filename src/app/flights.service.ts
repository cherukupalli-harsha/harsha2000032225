...
export class FlightsService {
  ...
  fetchFlights():Observable<any>{
   ...
   fetchfew(year:any,LaunchS:any) {
    console.log(year,LaunchS,17);
    return  this.http.get<any>("https://api.spaceXdata.com/v3/launches?limit=100&launch_success="+LaunchS+"&launch_year="+year);
